...
pub const SCRIPT_CURRENT = struct {
...
pub const SCRIPT_REQUEST = struct {
...
/// Request the overall list of mission items from the system/component.
pub const SCRIPT_REQUEST_LIST = struct {

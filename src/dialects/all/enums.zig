...
pub const MAV_MISSION_TYPE = enum(u32) {
...
pub const LANDING_TARGET_TYPE = enum(u32) {
...
pub const MISSION_STATE = enum(u32) {
...
pub const MAV_BATTERY_MODE = enum(u32) {
...
pub const VIDEO_STREAM_ENCODING = enum(u32) {
...
pub const WIFI_CONFIG_AP_RESPONSE = enum(u32) {
...
pub const STORAGE_TYPE = enum(u32) {
...
pub const MAV_BATTERY_CHARGE_STATE = enum(u32) {
...
pub const FENCE_MITIGATE = enum(u32) {
    /// Unknown
...
/// WiFi Mode.
pub const WIFI_CONFIG_AP_MODE = enum(u32) {
...
pub const GSM_MODEM_TYPE = enum(u32) {
    /// not specified
...
pub const GSM_LINK_TYPE = enum(u32) {
    /// no service
...
pub const GPS_SPOOFING_STATE = enum(u32) {
...
pub const GPS_RAIM_STATE = enum(u32) {
...
pub const TARGET_OBS_FRAME = enum(u32) {
    /// NED local tangent frame (x: North, y: East, z: Down) with origin fixed relative to earth.
...
pub const TARGET_ABSOLUTE_SENSOR_CAPABILITY_FLAGS = enum(u32) {
...
pub const GCS_CONTROL_STATUS_FLAGS = enum(u32) {
...
pub const GPS_AUTHENTICATION_STATE = enum(u32) {
...
pub const GPS_JAMMING_STATE = enum(u32) {
...
pub const AIRSPEED_SENSOR_FLAGS = enum(u32) {
...
pub const RADIO_RC_CHANNELS_FLAGS = enum(u32) {
...
pub const MLRS_RADIO_LINK_TYPE = enum(u32) {
...
pub const MLRS_RADIO_LINK_STATS_FLAGS = enum(u32) {
...
/// custom2.
pub const MAV_STORM32_GIMBAL_MANAGER_CLIENT = enum(u32) {
    /// For convenience.
...
/// 16.
pub const MAV_STORM32_GIMBAL_MANAGER_PROFILE = enum(u32) {
...
pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS = enum(u32) {

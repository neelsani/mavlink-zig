...
pub const MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS = enum(u32) {
...
pub const TARGET_ABSOLUTE_SENSOR_CAPABILITY_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const TARGET_ABSOLUTE_SENSOR_CAPABILITY_POSITION: @This() = .{ .bits = 1 };
    pub const TARGET_ABSOLUTE_SENSOR_CAPABILITY_VELOCITY: @This() = .{ .bits = 2 };
...
pub const AVSS_HORSEFLY_OPERATION_MODE = enum(u32) {
...
pub const MAV_STORM32_GIMBAL_MANAGER_CAP_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u32,
    ...
    pub const MAV_STORM32_GIMBAL_MANAGER_CAP_FLAGS_HAS_PROFILES: @This() = .{ .bits = 1 };
};

pub const GOPRO_PROTUNE_WHITE_BALANCE = enum(u32) {
    /// Auto.
...
pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u16,
    ...
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_RC_ACTIVE: @This() = .{ .bits = 1 };
    /// Request to set onboard/companion computer client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_ONBOARD_ACTIVE: @This() = .{ .bits = 2 };
    /// Request to set autopliot client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_AUTOPILOT_ACTIVE: @This() = .{ .bits = 4 };
    /// Request to set GCS client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_GCS_ACTIVE: @This() = .{ .bits = 8 };
    /// Request to set camera client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CAMERA_ACTIVE: @This() = .{ .bits = 16 };
    /// Request to set GCS2 client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_GCS2_ACTIVE: @This() = .{ .bits = 32 };
    /// Request to set camera2 client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CAMERA2_ACTIVE: @This() = .{ .bits = 64 };
    /// Request to set custom client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CUSTOM_ACTIVE: @This() = .{ .bits = 128 };
    /// Request to set custom2 client to active, or report this client is active.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_CLIENT_CUSTOM2_ACTIVE: @This() = .{ .bits = 256 };
    /// Request supervision. This flag is only for setting, it is not reported.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_SET_SUPERVISON: @This() = .{ .bits = 512 };
    /// Release supervision. This flag is only for setting, it is not reported.
    pub const MAV_STORM32_GIMBAL_MANAGER_FLAGS_SET_RELEASE: @This() = .{ .bits = 1024 };
};

/// State of RAIM processing.
pub const GPS_RAIM_STATE = enum(u8) {
...
pub const GIMBAL_AXIS_CALIBRATION_REQUIRED = enum(u32) {
...
pub const GPS_SYSTEM_ERROR_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u32,
    ...
    pub const GPS_SYSTEM_ERROR_INCOMING_CORRECTIONS: @This() = .{ .bits = 1 };
    /// There are problems with the configuration.
    pub const GPS_SYSTEM_ERROR_CONFIGURATION: @This() = .{ .bits = 2 };
    /// There are problems with the software on the GPS receiver.
    pub const GPS_SYSTEM_ERROR_SOFTWARE: @This() = .{ .bits = 4 };
    /// There are problems with an antenna connected to the GPS receiver.
    pub const GPS_SYSTEM_ERROR_ANTENNA: @This() = .{ .bits = 8 };
    /// There are problems handling all incoming events.
    pub const GPS_SYSTEM_ERROR_EVENT_CONGESTION: @This() = .{ .bits = 16 };
    /// The GPS receiver CPU is overloaded.
    pub const GPS_SYSTEM_ERROR_CPU_OVERLOAD: @This() = .{ .bits = 32 };
    /// The GPS receiver is experiencing output congestion.
    pub const GPS_SYSTEM_ERROR_OUTPUT_CONGESTION: @This() = .{ .bits = 64 };
};

/// State flags for X-Bit and reserved fields.
pub const UAVIONIX_ADSB_XBIT = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const UAVIONIX_ADSB_XBIT_ENABLED: @This() = .{ .bits = 128 };
};
...
pub const GOPRO_PROTUNE_COLOUR = enum(u32) {
    /// Auto.
...
pub const COPTER_MODE = enum(u32) {
    /// STABILIZE
...
pub const UAVIONIX_ADSB_OUT_RF_SELECT = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const UAVIONIX_ADSB_OUT_RF_SELECT_RX_ENABLED: @This() = .{ .bits = 1 };
    pub const UAVIONIX_ADSB_OUT_RF_SELECT_TX_ENABLED: @This() = .{ .bits = 2 };
};
...
pub const GPS_JAMMING_STATE = enum(u8) {
...
pub const MAV_STORM32_GIMBAL_MANAGER_CLIENT = enum(u8) {
    /// For convenience.
...
pub const EKF_STATUS_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u16,
...
pub const GCS_CONTROL_STATUS_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const GCS_CONTROL_STATUS_FLAGS_SYSTEM_MANAGER: @This() = .{ .bits = 1 };
    ...
    pub const GCS_CONTROL_STATUS_FLAGS_TAKEOVER_ALLOWED: @This() = .{ .bits = 2 };
};
...
pub const GOPRO_PROTUNE_EXPOSURE = enum(u32) {
    /// -5.0 EV (Hero 3+ Only).
...
pub const UALBERTA_NAV_MODE = enum(u32) {
    NAV_AHRS_INIT = 1,
    /// AHRS mode
    NAV_AHRS = 2,
...
pub const GOPRO_FIELD_OF_VIEW = enum(u32) {
    /// 0x00: Wide.
...
pub const GIMBAL_AXIS_CALIBRATION_STATUS = enum(u32) {
...
pub const UAVIONIX_ADSB_OUT_CONTROL_STATE = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const UAVIONIX_ADSB_OUT_CONTROL_STATE_EXTERNAL_BARO_CROSSCHECKED: @This() = .{ .bits = 1 };
    pub const UAVIONIX_ADSB_OUT_CONTROL_STATE_ON_GROUND: @This() = .{ .bits = 4 };
    pub const UAVIONIX_ADSB_OUT_CONTROL_STATE_IDENT_BUTTON_ACTIVE: @This() = .{ .bits = 8 };
    pub const UAVIONIX_ADSB_OUT_CONTROL_STATE_MODE_A_ENABLED: @This() = .{ .bits = 16 };
    pub const UAVIONIX_ADSB_OUT_CONTROL_STATE_MODE_C_ENABLED: @This() = .{ .bits = 32 };
    pub const UAVIONIX_ADSB_OUT_CONTROL_STATE_MODE_S_ENABLED: @This() = .{ .bits = 64 };
    pub const UAVIONIX_ADSB_OUT_CONTROL_STATE_1090ES_TX_ENABLED: @This() = .{ .bits = 128 };
};

/// RADIO_LINK_TYPE enum.
pub const MLRS_RADIO_LINK_TYPE = enum(u8) {
...
pub const GPS_AUTHENTICATION_STATE = enum(u8) {
...
pub const MAV_QSHOT_MODE = enum(u32) {
...
pub const GIMBAL_AXIS = enum(u32) {
    /// Gimbal yaw axis.
    GIMBAL_AXIS_YAW = 0,
    /// Gimbal pitch axis.
    GIMBAL_AXIS_PITCH = 1,
...
pub const LIMIT_MODULE = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    /// Pre-initialization.
    pub const LIMIT_GPSLOCK: @This() = .{ .bits = 1 };
    /// Disabled.
    pub const LIMIT_GEOFENCE: @This() = .{ .bits = 2 };
    /// Checking limits.
    pub const LIMIT_ALTITUDE: @This() = .{ .bits = 4 };
};

pub const GOPRO_VIDEO_SETTINGS_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u32,
    ...
    /// 0=NTSC, 1=PAL.
    pub const GOPRO_VIDEO_SETTINGS_TV_MODE: @This() = .{ .bits = 1 };
};
...
pub const GPS_SPOOFING_STATE = enum(u8) {
...
pub const RADIO_RC_CHANNELS_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u16,
    ...
    pub const RADIO_RC_CHANNELS_FLAGS_FAILSAFE: @This() = .{ .bits = 1 };
    ...
    pub const RADIO_RC_CHANNELS_FLAGS_OUTDATED: @This() = .{ .bits = 2 };
};
...
/// State flags for ADS-B transponder dynamic report
pub const UAVIONIX_ADSB_OUT_DYNAMIC_STATE = packed struct {
    pub const is_bitmask = true;
    bits: u16,
    ...
    pub const UAVIONIX_ADSB_OUT_DYNAMIC_STATE_INTENT_CHANGE: @This() = .{ .bits = 1 };
    pub const UAVIONIX_ADSB_OUT_DYNAMIC_STATE_AUTOPILOT_ENABLED: @This() = .{ .bits = 2 };
    pub const UAVIONIX_ADSB_OUT_DYNAMIC_STATE_NICBARO_CROSSCHECKED: @This() = .{ .bits = 4 };
    pub const UAVIONIX_ADSB_OUT_DYNAMIC_STATE_ON_GROUND: @This() = .{ .bits = 8 };
...
pub const UALBERTA_PILOT_MODE = enum(u32) {
    PILOT_MANUAL = 1,
    PILOT_AUTO = 2,
    /// Rotomotion mode
    PILOT_ROTO = 3,
...
pub const TRACKER_MODE = enum(u32) {
    /// MANUAL
...
pub const GOPRO_RESOLUTION = enum(u32) {
    /// 848 x 480 (480p).
...
pub const MAV_BATTERY_STATUS_FLAGS = packed struct {
    ...
    pub const MAV_BATTERY_STATUS_FLAGS_NOT_READY_TO_USE: @This() = .{ .bits = 1 };
    /// Battery is charging.
    pub const MAV_BATTERY_STATUS_FLAGS_CHARGING: @This() = .{ .bits = 2 };
    /// Battery is cell balancing (during charging).
    ///           Not ready to use (MAV_BATTERY_STATUS_FLAGS_NOT_READY_TO_USE may be set).
    pub const MAV_BATTERY_STATUS_FLAGS_CELL_BALANCING: @This() = .{ .bits = 4 };
    /// Battery cells are not balanced.
    ///           Not ready to use.
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_CELL_IMBALANCE: @This() = .{ .bits = 8 };
    /// Battery is auto discharging (towards storage level).
    ///           Not ready to use (MAV_BATTERY_STATUS_FLAGS_NOT_READY_TO_USE would be set).
    pub const MAV_BATTERY_STATUS_FLAGS_AUTO_DISCHARGING: @This() = .{ .bits = 16 };
    ...
    pub const MAV_BATTERY_STATUS_FLAGS_REQUIRES_SERVICE: @This() = .{ .bits = 32 };
    /// Battery is faulty and cannot be repaired (not safe to fly).
    ///           This is set at vendor discretion.
    ///           The battery should be disposed of safely.
    pub const MAV_BATTERY_STATUS_FLAGS_BAD_BATTERY: @This() = .{ .bits = 64 };
    ...
    pub const MAV_BATTERY_STATUS_FLAGS_PROTECTIONS_ENABLED: @This() = .{ .bits = 128 };
    ...
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_PROTECTION_SYSTEM: @This() = .{ .bits = 256 };
    /// One or more cells are above their maximum voltage rating.
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_OVER_VOLT: @This() = .{ .bits = 512 };
    ...
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_UNDER_VOLT: @This() = .{ .bits = 1024 };
    /// Over-temperature fault.
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_OVER_TEMPERATURE: @This() = .{ .bits = 2048 };
    /// Under-temperature fault.
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_UNDER_TEMPERATURE: @This() = .{ .bits = 4096 };
    /// Over-current fault.
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_OVER_CURRENT: @This() = .{ .bits = 8192 };
    /// Short circuit event detected.
    ///           The battery may or may not be safe to use (check other flags).
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_SHORT_CIRCUIT: @This() = .{ .bits = 16384 };
    /// Voltage not compatible with power rail voltage (batteries on same power rail should have similar voltage).
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_INCOMPATIBLE_VOLTAGE: @This() = .{ .bits = 32768 };
    /// Battery firmware is not compatible with current autopilot firmware.
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_INCOMPATIBLE_FIRMWARE: @This() = .{ .bits = 65536 };
    /// Battery is not compatible due to cell configuration (e.g. 5s1p when vehicle requires 6s).
    pub const MAV_BATTERY_STATUS_FLAGS_FAULT_INCOMPATIBLE_CELLS_CONFIGURATION: @This() = .{ .bits = 131072 };
...
pub const UAVIONIX_ADSB_RF_HEALTH = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const UAVIONIX_ADSB_RF_HEALTH_OK: @This() = .{ .bits = 1 };
    pub const UAVIONIX_ADSB_RF_HEALTH_FAIL_TX: @This() = .{ .bits = 2 };
    pub const UAVIONIX_ADSB_RF_HEALTH_FAIL_RX: @This() = .{ .bits = 16 };
};
...
pub const UAVIONIX_ADSB_OUT_STATUS_FAULT = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const UAVIONIX_ADSB_OUT_STATUS_FAULT_STATUS_MESSAGE_UNAVAIL: @This() = .{ .bits = 8 };
    pub const UAVIONIX_ADSB_OUT_STATUS_FAULT_GPS_NO_POS: @This() = .{ .bits = 16 };
    pub const UAVIONIX_ADSB_OUT_STATUS_FAULT_GPS_UNAVAIL: @This() = .{ .bits = 32 };
    pub const UAVIONIX_ADSB_OUT_STATUS_FAULT_TX_SYSTEM_FAIL: @This() = .{ .bits = 64 };
    pub const UAVIONIX_ADSB_OUT_STATUS_FAULT_MAINT_REQ: @This() = .{ .bits = 128 };
};
...
pub const HEADING_TYPE = enum(u32) {
...
pub const MAV_STORM32_TUNNEL_PAYLOAD_TYPE = enum(u32) {
...
pub const MLRS_RADIO_LINK_STATS_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u16,
    ...
    pub const MLRS_RADIO_LINK_STATS_FLAGS_RSSI_DBM: @This() = .{ .bits = 1 };
    /// Rx receive antenna. When set the data received on antenna 2 are taken, else the data stems from antenna 1.
    pub const MLRS_RADIO_LINK_STATS_FLAGS_RX_RECEIVE_ANTENNA2: @This() = .{ .bits = 2 };
    /// Rx transmit antenna. Data are transmitted on antenna 1.
    pub const MLRS_RADIO_LINK_STATS_FLAGS_RX_TRANSMIT_ANTENNA1: @This() = .{ .bits = 4 };
    /// Rx transmit antenna. Data are transmitted on antenna 2.
    pub const MLRS_RADIO_LINK_STATS_FLAGS_RX_TRANSMIT_ANTENNA2: @This() = .{ .bits = 8 };
    /// Tx receive antenna. When set the data received on antenna 2 are taken, else the data stems from antenna 1.
    pub const MLRS_RADIO_LINK_STATS_FLAGS_TX_RECEIVE_ANTENNA2: @This() = .{ .bits = 16 };
    /// Tx transmit antenna. Data are transmitted on antenna 1.
    pub const MLRS_RADIO_LINK_STATS_FLAGS_TX_TRANSMIT_ANTENNA1: @This() = .{ .bits = 32 };
...
pub const SECURE_COMMAND_OP = enum(u32) {
...
pub const MAV_STORM32_GIMBAL_MANAGER_PROFILE = enum(u8) {
...
pub const GOPRO_PHOTO_RESOLUTION = enum(u32) {
    /// 5MP Medium.
...
pub const MAV_CMD = enum(u16) {
    ...
    MAV_CMD_ODID_SET_EMERGENCY = 12900,
...
pub const GOPRO_BURST_RATE = enum(u32) {
    /// 3 Shots / 1 Second.
...
pub const MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL = enum(u32) {
    /// Switch Low.
...
pub const GOPRO_FRAME_RATE = enum(u32) {
    /// 12 FPS.
...
pub const GSM_MODEM_TYPE = enum(u8) {
    /// not specified
...
pub const MAV_AVSS_COMMAND_FAILURE_REASON = enum(u32) {
...
pub const TARGET_OBS_FRAME = enum(u8) {
    /// NED local tangent frame (x: North, y: East, z: Down) with origin fixed relative to earth.
...
pub const LED_CONTROL_PATTERN = enum(u32) {
...
pub const GOPRO_PROTUNE_SHARPNESS = enum(u32) {
    /// Low Sharpness.
...
pub const ACCELCAL_VEHICLE_POS = enum(u32) {
...
pub const UAVIONIX_ADSB_OUT_STATUS_STATE = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_ON_GROUND: @This() = .{ .bits = 1 };
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_INTERROGATED_SINCE_LAST: @This() = .{ .bits = 2 };
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_XBIT_ENABLED: @This() = .{ .bits = 4 };
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_IDENT_ACTIVE: @This() = .{ .bits = 8 };
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_MODE_A_ENABLED: @This() = .{ .bits = 16 };
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_MODE_C_ENABLED: @This() = .{ .bits = 32 };
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_MODE_S_ENABLED: @This() = .{ .bits = 64 };
    pub const UAVIONIX_ADSB_OUT_STATUS_STATE_1090ES_TX_ENABLED: @This() = .{ .bits = 128 };
};

pub const GOPRO_HEARTBEAT_FLAGS = packed struct {
    pub const is_bitmask = true;
    bits: u8,
    ...
    pub const GOPRO_FLAG_RECORDING: @This() = .{ .bits = 1 };
};
...
pub const SCRIPTING_CMD = enum(u32) {
...
pub const MAV_MODE_GIMBAL = enum(u32) {
...
pub const GOPRO_MODEL = enum(u32) {
    /// Unknown gopro model.
...
pub const UALBERTA_AUTOPILOT_MODE = enum(u32) {
...
pub const AVSS_M300_OPERATION_MODE = enum(u32) {
    /// In manual control mode

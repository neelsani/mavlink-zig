...
pub const FLEXIFUNCTION_COMMAND_ACK = struct {
...
pub const FLEXIFUNCTION_READ_REQ = struct {
...
pub const FLEXIFUNCTION_BUFFER_FUNCTION_ACK = struct {
...
/// Acknowldge success or failure of a flexifunction command
pub const FLEXIFUNCTION_DIRECTORY = struct {
    ...
    /// Settings data
    directory_data: [48]i8,

};

/// Backwards compatible version of SERIAL_UDB_EXTRA - F2: Part B
pub const SERIAL_UDB_EXTRA_F2_B = struct {
...
pub const SERIAL_UDB_EXTRA_F13 = struct {
...
pub const SERIAL_UDB_EXTRA_F18 = struct {
    pub const MSG_ID = 184;
    /// SUE Angle of Attack Normal
    angle_of_attack_normal: f32,

    /// SUE Angle of Attack Inverted
    angle_of_attack_inverted: f32,

    /// SUE Elevator Trim Normal
    elevator_trim_normal: f32,

    /// SUE Elevator Trim Inverted
    elevator_trim_inverted: f32,
...
/// Acknowldge success or failure of a flexifunction command
pub const FLEXIFUNCTION_COMMAND = struct {
...
pub const SERIAL_UDB_EXTRA_F15 = struct {
    pub const MSG_ID = 179;
    /// Serial UDB Extra Model Name Of Vehicle
    sue_ID_VEHICLE_MODEL_NAME: [40]u8,

    /// Serial UDB Extra Registraton Number of Vehicle
    sue_ID_VEHICLE_REGISTRATION: [20]u8,

};

/// Backwards compatible version of SERIAL_UDB_EXTRA F21 format
pub const SERIAL_UDB_EXTRA_F21 = struct {
    pub const MSG_ID = 187;
    /// SUE X accelerometer offset
    sue_accel_x_offset: i16,

    /// SUE Y accelerometer offset
    sue_accel_y_offset: i16,

    /// SUE Z accelerometer offset
    sue_accel_z_offset: i16,

    /// SUE X gyro offset
    sue_gyro_x_offset: i16,

    /// SUE Y gyro offset
    sue_gyro_y_offset: i16,

    /// SUE Z gyro offset
    sue_gyro_z_offset: i16,

};

/// The airspeed measured by sensors and IMU
pub const AIRSPEEDS = struct {
